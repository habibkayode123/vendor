...
function SinglePurchaseRequest({ match, actions }) {
        ...
        axios.get(`/v1/request/${uuid}`)
            .then(res => {
                ...
                if (data.approvalStatus == 1)
                    data.approvalStatusReadable = 'Approved'
    ...
    const handleShow = (type) => {
        ...
        if (type == 'Decline')
            setReviewData({...reviewData, status: 2});
        else
            setReviewData({...reviewData, status: 1});
    };
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <Row>
                                    ...
                                    <Col md="3">
                                        <Card>
                                            ...
                                            <Card.Body>
                                                <Card.Text>{new Date(request.createdAt).toLocaleDateString()}</Card.Text>
                                            </Card.Body>
                                        </Card>
                                    </Col>
                                </Row>
                                ...
                                <Row>
                                            ...
                                            <Card>
                                                ...
                                                <Card.Body>
                                                    <ul>
                                                        ...
                                                        <li>Date: {new Date(request.reviewDate).toLocaleDateString()}</li>
                                    ...
                                    {request.reviewStatus == 1 && <Col md="6">
                                        <Accordion defaultActiveKey="0">
                                            <Card>
                                                <Accordion.Toggle as={Card.Header} eventKey="0" className="d-flex justify-content-between">
                                                ...
                                                {request.approvalStatus && (<Accordion.Collapse eventKey="0">
                                                <Card.Body>
                                                    <ul>
                                                        <li>Approved By: {request.approvedBy}</li>
                                                        <li>Date: {new Date(request.approvalDate).toLocaleDateString()}</li>
                ...
                <Modal.Body>
                    <Form>
                        <Form.Group controlId="reviewStatus">
                            <Form.Label hidden={showModal.type !== 'Review'}>Status</Form.Label>
                            <Form.Control 
                                name="status"
                        ...
                        <Form.Group controlId="reviewComment">
                            ...
                            <Form.Control as="textarea" rows={3} name="comment" value={reviewData.comment} onChange={handleOnChange} />
                        </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
